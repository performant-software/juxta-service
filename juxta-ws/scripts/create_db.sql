...
CREATE TABLE `text_incrementer` (
  `text_qname_sequence` bigint(20) NOT NULL DEFAULT '0',
  `text_content_sequence` bigint(20) NOT NULL DEFAULT '0',
  `text_annotation_sequence` bigint(20) NOT NULL DEFAULT '0',
  `text_annotation_link_sequence` bigint(20) NOT NULL DEFAULT '0'
...
CREATE TABLE `text_qname` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `local_name` (`local_name`,`namespace`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
